    ...
    return (
        <div className="resources-container">
            <div className="resources-content">
                ...
                <div style={{ display: 'flex', flexDirection: 'row', gap: '20px', marginBottom: '20px', flexWrap: 'wrap' }}>
                    <div style={{ flex: '1', minWidth: '300px' }}>
                        <p>The United Nations' eleventh goal, sustainable cities and communities, aims to make cities inclusive, safe, resilient, and sustainable. By 2030, they aim to ensure that everyone has access to sufficient, safe, and affordable housing and basic services.</p>
                    ...
                    <div style={{ flex: '0 0 auto', maxWidth: '300px' }}>
                        <img 
                            src='/img/sdg11.jpg' 
                            alt="UN Sustainable Development Goal 11 logo" 
                ...
                <div style={{ display: 'flex', flexDirection: 'row', gap: '20px', marginBottom: '20px', flexWrap: 'wrap' }}>
                    ...
                    <div style={{ flex: '0 0 auto', maxWidth: '300px' }}>
                        <img 
                            src='/img/HousingCrisis.jpg' 
                            alt="Affordable housing crisis illustration" 
                            style={{ width: '100%', height: 'auto', borderRadius: '8px' }}
                        />
                    </div>
                </div>
                ...
                <p><a href="https://www.seattle.gov/utilities/your-services/accounts-and-payments">Seattle Public Utilities</a>: Information about utility services, account management, and payment options for Seattle residents.</p>
                
                <p><a href="https://www.seattle.gov/city-light/start-or-stop-service">Seattle City Light</a>: Start or stop electricity service to ensure your power is on when you move in.</p>
                
                <p><a href="https://depts.washington.edu/slsuw/">UW Student Legal Services</a>: Contact Student Legal Services for free legal advice on lease agreements, tenant rights, and landlord disputes.</p>

                <h2>Moving Services on Campus</h2>
                <p><a href="https://www.washington.edu/parents/move-in-and-out-resources/">UW Move-In and Move-Out Resources</a>: The University of Washington provides resources and information to help students with the moving process, including schedules, storage options, and transportation services.</p>
                ...
                <div className="video-container" style={{ maxWidth: '600px', margin: '0 auto' }}>
                    <iframe 
                        width="560" 
                        height="315" 
